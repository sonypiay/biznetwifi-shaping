        ...
        <div class="uk-grid-small" uk-grid>
          ...
          <div class="uk-width-1-3@xl uk-width-1-3@l uk-width-1-3@m uk-width-1-1@s">
            <div class="uk-width-1-1 uk-inline">
              <a @click="getLogActivity( pagination.path + '?page=1' )" class="uk-form-icon" uk-icon="search"></a>
              <input @keyup.enter="getLogActivity( pagination.path + '?page=1' )" type="text" placeholder="Search keywords..." v-model="forms.keywords" class="uk-width-1-1 uk-input form-content-input">
            </div>
          </div>
        </div>
        <div class="uk-margin-top uk-overflow-auto">
          <table class="uk-table uk-table-small uk-table-middle uk-table-divider uk-table-hover uk-table-striped table-data-content">
            <thead>
              <tr>
                <th>Date and Time</th>
                <th>Administrator</th>
